...
//            antibioticList.antibiotics.forEach(() => {
//                if(this.get("ID").contains(name)) {
//                    console.log("Found antibiotic!");
//                    return this;
//                }
//            })
        ...
        antibioticSpans.forEach((antibioticSpan) => {
            ...
            antibioticSpan.addEventListener('click', () => {
                ...
                if (developerVersion === true) {
                    ...
                    if(currentAntibiotic.Oralisierung) {
                        text += "<strong>Oralisierung:</strong><br>(Bedingungen s.u.)<br>" + currentAntibiotic.Oralisierung + "<br><br>";
                    }
                    text += "<strong>Niereninsuffizienz:</strong><br>" + currentAntibiotic.Dosisanpassung_Niereninsuffizienz + "<br><br>";
                    text += "<strong>Hämodialyse:</strong><br>" + currentAntibiotic.Dosisanpassung_Dialyse + "<br><br>";
                    text += "<strong>Leberinsuffizienz:</strong><br>" + currentAntibiotic.Dosisanpassung_Leberinsuffizienz + "<br><br>";
                    text += "<strong>Monitoring:</strong><br>" + currentAntibiotic.Monitoring + "<br><br>";
                    text += "<strong>Besonderheiten:</strong><br>" + currentAntibiotic.Besonderheiten + "<br><br>";
                    text += "<strong>Bedingungen Oralisierung:</strong><br>" + oralisationMap.get(currentAntibiotic.Oralisierung_Voraussetzungen) + "<br><br>";
                    infoBoxContent.innerHTML = text;
                } else {
                    text = "<p><strong>" + currentAntibiotic.Name + "</strong><br><br><strong>Dosierung:</strong><br>" + currentAntibiotic.Standarddosis + "<br><br>";
                    text += "<strong>Niereninsuffizienz:</strong><br>" + currentAntibiotic.Dosisanpassung_Niereninsuffizienz + "<br><br>";
                    text += "<strong>Dialyse:</strong><br>" + currentAntibiotic.Dosisanpassung_Dialyse + "<br><br>";
